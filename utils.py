...
class utilities:
    ...
    def get_random_name(self):
        self.animal = self.animals[random.randint(0, 171)]
        self.adjective = self.adjective[random.randint(0, 199)]
        self.today = date.today().isoformat()
        self.filename_string = self.today + "_" + self.animal + "_" + self.adjective 
